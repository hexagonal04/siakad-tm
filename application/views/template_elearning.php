    ...
    -->
    	<div class="sidebar-wrapper" data-color="green">
            ...
            <ul class="nav">
                ...
                echo generate_menu_elearning($admlevel,$walikelas['is_wali']);  
                ?>
            </ul>
    	</div>
    </div>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="pe-7s-study"></i> SIMS (Sistem Informasi Manajemen Sekolah)</a>
                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <p class="copyright pull-left">
                    <b>SMA Taruna Mandiri</b>
                </p>
                <p class="copyright pull-right">
                    Waktu proses {elapsed_time} detik. &copy; 2021 <a title="Bayu" target="_blank">SMA Taruna Mandiri</a>
                </p>
            </div>
        </footer>
