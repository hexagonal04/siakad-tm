...
<script type="text/javascript">
    $(document).on("ready", function() {
        pagination("datatabel", base_url+"data_kepsek/datatable", []);
    ...
    function edit(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"data_kepsek/edit/"+id,
    ...
    function hapus(id) {
        ...
        if (confirm('Anda yakin..? ')) {
            ...
            $.ajax({
                type: "GET",
                url: base_url+"data_kepsek/hapus/"+id,
                success: function(data) {
    ...
    function aktifkan(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"data_kepsek/aktifkan/"+id,
            success: function(data) {
    ...
    function nonaktifkan(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"data_kepsek/nonaktifkan/"+id,
            success: function(data) {
                noti("success", data.data);
                pagination("datatabel", base_url+"data_kepsek/datatable", []);
            }
