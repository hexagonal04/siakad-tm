...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama Sekolah</td><td width="1%">:</td><td width="39%" class="tbl">SMA Taruna Mandiri</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nama_kelas']); ?></td>
		</tr>
		<tr>
			<td>Alamat Sekolah</td><td>:</td><td class="tbl">Benda Baru II, Pamulang, Tangerang Selatan</td>
			...
			<td colspan="6">
				...
				<table width="100%">
					<tr>
						...
						<td width="10%"></td>
						<td width="30%">
							Tangerang Selatan, <?php echo $this->config->item('tgl_cetak'); ?><br>
							Kepala SMA Taruna Mandiri <br>
							<br><br><br><br>
							<u><b>Winarti Astuti, S.Pd</b></u><br>
