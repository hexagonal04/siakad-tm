...
<body>
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/tm.png" style="margin-top: 10px; width: 120px; height: 80px">
			</td>
			<td style="text-align: center"><b>DINAS PENDIDIKAN KOTA TANGERANG SELATAN<br>
			...
			Telp : Telepon :(021) 7463-5180 | Web : https://www.sekolahtarunamandiri.sch.id/</span>
			</td>
		</tr>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		Tangerang Selatan, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>
		Kepala SMA<br>
		<br>
		<br>
		<br>
		<br>
		<b><u>Winarti Astuti, S. Pd</u></b><br>
