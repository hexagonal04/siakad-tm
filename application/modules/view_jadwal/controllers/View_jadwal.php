...
class View_jadwal extends CI_Controller {
	function __construct() {
        parent::__construct();
        $this->sespre = $this->config->item('session_name_prefix');

        $this->d['admlevel'] = $this->session->userdata($this->sespre.'level');
        $this->d['url'] = "view_jadwal";
        $this->d['idnya'] = "viewjadwal";
        $this->d['id_guru'] = $this->session->userdata($this->sespre.'id_guru');
        $this->d['nama_form'] = "f_viewjadwal";
    ...
    public function datatable() {
        ...
        $d_total_row = $this->db->query("SELECT
                                        ...
                                        WHERE a.id_guru = ".$this->d['id_guru']."
        ...
        $q_datanya = $this->db->query("SELECT
                                    ...
                                    INNER JOIN m_kelas c ON a.id_kelas = c.id
                                    INNER JOIN m_mapel d ON a.id_mapel = d.id
                                    WHERE a.id_guru = ".$this->d['id_guru']." AND 
    ...
    public function index() {
        $this->d['guru_jadwal'] = $this->db->query("SELECT * FROM t_jadwal a
                                                    WHERE a.id_guru = ".$this->d['id_guru']."")->result_array();
    	$this->d['p'] = "list";
