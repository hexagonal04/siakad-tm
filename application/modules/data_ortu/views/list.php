<div class="card">
    ...
    <div class="content">
        ...
        <table class="table table-hover table-striped" id="datatabel" style="width: 100%">
            <thead>
                <td width="10%">No</td>
                <td width="20%">Nama / Username / Password Default</td>
                <td width="10%">ID Anak/Siswa</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Orang Tua</h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="nama" class="col-sm-3 control-label">ID Anak (Siswa)</label>
                    <div class="col-sm-9">
...
<script type="text/javascript">
    $(document).on("ready", function() {
        pagination("datatabel", base_url+"data_ortu/datatable", []);
    ...
    function edit(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"data_ortu/edit/"+id,
    ...
    function hapus(id) {
        ...
        if (confirm('Anda yakin..? ')) {
            ...
            $.ajax({
                type: "GET",
                url: base_url+"data_ortu/hapus/"+id,
                success: function(data) {
    ...
    function aktifkan(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"data_ortu/aktifkan/"+id,
            success: function(data) {
    ...
    function nonaktifkan(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"data_ortu/nonaktifkan/"+id,
            success: function(data) {
                noti("success", data.data);
                pagination("datatabel", base_url+"data_ortu/datatable", []);
            }
