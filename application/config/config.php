...
$config['base_url'] = 'https://siakadtm.net/'; 
...
$config['nama_sekolah'] = "SMA Taruna Mandiri";
$config['alamat_sekolah'] = "Jl. Raya Pamulang II No. 3";
$config['kota_sekolah'] = "Tangerang Selatan";
